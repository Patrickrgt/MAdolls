          ...
          <div className="animate-fadeRight group-hover:border-[#FF0083] border-l-[1vh] pl-[2vh] transition-all ease-in-out cursor-none">
            <div className="animate-fadeLeft">
              ...
              <p className="text-[1.5vh] hover:text-[#FF0083] leading-tight mt-[0.5vh] transition-all ease-in-out">
                ...
                and my thoughts for all of you. {`Let's`} play around with novelty, unbound by anything. Just like
                back then.
              </p>
              ...
              <p className="text-[1.5vh] font-normal mt-[0.5vh] hover:text-[#FF0083] transition-all ease-in-out">
                元カラーデザイナーとして、私は色に強い情熱を持っています。私の表現の一環として、同じ肌の色をしたMAdollは2体といません。「どんな色も輝ける」というのが、NFTクリエイターとしての一貫したポリシーです。様々な喜び、逆風、そして挑戦をこれからも皆さんと分かち合いたい。                ルールや状況が変化する不確実な未来に向かって前進している今、私はこのコレクションについて具体的な特典やエアドロップを約束することはできません。私が約束するのは、私の努力と皆さんへの思いです。
              </p>
              <p className="text-[1.5vh] font-normal mt-[0.5vh] hover:text-[#FF0083] transition-all ease-in-out">
          ...
          <div className="grid grid-rows-2 grid-cols-3">
            {MAdolls.map((doll, id) => (
              <button
                ...
                className="animate-fadeIn h-[20vh] lg:opacity-0 w-auto aspect-square p-0 border-0 m-auto"
              >
                <Image
