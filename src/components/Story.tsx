        ...
        <div className="w-[80%] group">
          <div className="animate-fadeRight group-hover:border-[#FF0083] border-l-[1vh] pl-[2vh] transition-all ease-in-out cursor-none">
            <div className="animate-fadeLeft">
              ...
              <p className="text-[1.5vh] hover:text-[#FF0083] leading-tight mt-[0.5vh] transition-all ease-in-out">
                I want to continue to share with you the various joys, headwinds
                and challenges. MAdoll is a “cyber doll” inspired by the dolls
                we all played with in our childhood.
              </p>
              <p className="text-[1.5vh] hover:text-[#FF0083] leading-tight mt-[0.5vh] transition-all ease-in-out">
      ...
      <div className="w-[70%]">
        <div className="grid grid-cols-2">
          <Image
            src={MAdolls[curDoll]}
            alt="MAdoll"
            className="animate-fadeIn h-full w-fit"
              placeholder="blur"
